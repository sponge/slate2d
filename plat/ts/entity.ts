...
class Entity {
  ...
  drawBbox(r: number, g: number, b: number, a: number) {
  ...
  *findTriggers() {
  ...
  handlePlayerStomp(other: Entity, dir: Dir, die = true) {
