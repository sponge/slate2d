...
public:
  ...
  operator bool() const { return JS_ToBool(ctx, val); }
  ...
  bool isString() const { return JS_IsString(val); }

  bool isObject() const { return JS_IsObject(val); }

  bool isNumber() const { return JS_IsNumber(val); }

  bool isUndefined() const { return JS_IsUndefined(val); }

  bool isException() const { return JS_IsException(val); }

  bool isFunction() const { return JS_IsFunction(ctx, val); }
  ...
  const char *asCString() const { return cStr; }
