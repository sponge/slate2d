...
class TowersEnding {
   ...
   construct new(params) {
      ...
      _text = "Hello, This is Clive speaking. I can't express just how much pleasure it brings me, to see so many tens of dozen of people trying to climb my tower. Whether it's the diehard goatheads and battlement defencers, or the random man on the street who just hears some hubbub in his local Wimpy, about my tower, and decides have a go for himself.
