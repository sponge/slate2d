...
void GameScene::Startup(ClientInfo* info) {
	...
	trap->Asset_BMPFNT_Set(font, "!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~", -1, 7, 16);
...
void GameScene::Render() {
	DC_Clear();
	DC_SetTransform(inf->width / inf->gameWidth, 0, 0, inf->width / inf->gameWidth, 0, 0, true);
