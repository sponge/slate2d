...
#define PADBASE(i) (CONTROLLER_KEY_START + SDL_GAMEPAD_BUTTON_MAX * (i - 1))
#define GAMEPAD(i) \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_SOUTH] = "PAD" #i "_A", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_EAST] = "PAD" #i "_B", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_WEST] = "PAD" #i "_X", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_NORTH] = "PAD" #i "_Y", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_BACK] = "PAD" #i "_BACK", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_GUIDE] = "PAD" #i "_GUIDE", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_START] = "PAD" #i "_START", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_LEFT_STICK] = "PAD" #i "_L3", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_RIGHT_STICK] = "PAD" #i "_R3", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_LEFT_SHOULDER] = "PAD" #i "_L1", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER] = "PAD" #i "_R1", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_DPAD_UP] = "PAD" #i "_UP", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_DPAD_DOWN] = "PAD" #i "_DOWN", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_DPAD_LEFT] = "PAD" #i "_LEFT", \
	[PADBASE(i) + SDL_GAMEPAD_BUTTON_DPAD_RIGHT] = "PAD" #i "_RIGHT",
